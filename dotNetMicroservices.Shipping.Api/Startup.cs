...
namespace dotNetMicroservices.Shipping.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("ShippingDbContext"));
            });
        ...
        private void SwaggerConfig(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Shipping Microservices", Version = "v1" });
            });
        }
        ...
        private void RegisterServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ShippingDbContext>();
        }
